...
# https://github.com/noahwaterfieldprice/python_primer/blob/master/ch_5/animate_Taylor_series-sin(x).gif
# https://github.com/noahwaterfieldprice/python_primer/blob/master/ch_5/animate_Taylor_series-exp(x).gif
